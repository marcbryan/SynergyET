...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            // Listener de pulsación larga
            show_message.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    // Texto para mostrar en el toast
                    String copied = v.getContext().getString(R.string.msg_copied_clipboard);
                    ...
                    ClipData clip = ClipData.newPlainText(copied, show_message.getText());
                    clipboard.setPrimaryClip(clip);
                    // Mostramos un toast diciendo que se ha copiado el texto
